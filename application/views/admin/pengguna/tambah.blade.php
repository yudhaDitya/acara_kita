...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="mb-0 mt-2 align-items-center">Tambah Pengguna</h3> 
                </div>
            ...
            <div class="card-body"> 
                ...
                <form action="{{ site_url('admin/pengguna/simpan') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control" id="nama_user" name="nama_user" value="{{ set_value("nama_user") }}">
                        </div>
                    </div>    
                    <div class="form-group row">
                        <label for="username" class="col-sm-2 col-form-label">Username</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control" id="username" name="username" value="{{ set_value("username") }}">
                        </div>
                    </div>    
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <select name="hak_akses" id="hak_akses" class="form-control" required>
                                ...
                                <option value="PG">Penjaga Gudang</option>
