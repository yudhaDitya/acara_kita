            ...
            <div class="card-body"> 
                <form action="{{ site_url('admin/barang/simpan') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control" id="nama_barang" name="nama_barang">
                        </div>
                    </div> 
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control" id="harga_beli" name="harga_beli">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="harga_jual" class="col-sm-2 col-form-label">Harga Jual</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control form-control" id="harga_jual" name="harga_jual">
                        </div>
                    </div> 
                    <div class="form-group row">
                        <label for="stok" class="col-sm-2 col-form-label">Jumlah Stok</label>
                        <div class="col-sm-3">
                            <input type="number" class="form-control form-control" id="stok" name="stok">
                        </div>
                    </div> 
                    <div class="form-group row">
